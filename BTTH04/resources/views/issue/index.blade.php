	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>Manage <b>Computer lab</b></h2>
					</div>
					
					<div class="col-sm-6">
						<a href="{{ route('issue.create') }}" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Thêm vấn đề mới</span></a>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
                    @foreach ($issues as $issue)
                        <tr>
                            <!-- computer ko can s vi su dung computer trong model (chac the) -->
                            <td>{{ $issue->id }}</td>
                            ...
                            <td>{{ $issue->status }}</td>
                            <td>
                                <a href="{{ route('issue.edit', $issue->id) }}" class="btn btn-primary">Sửa</a>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Bạn có chắc chắn muốn xóa vấn để {{ $issue->id }} này không?
                                            </div>
